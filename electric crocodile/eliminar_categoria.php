...
<body>
	...
	<section>
		...
		<div class="warning_div">
			...
			<span>Seguro que quieres eliminar la Categoria <?php echo $id_categoria?>?</span>
		...
		if(isset($_POST['eliminar'])){
			$instruccion_categoria="DELETE FROM categoria WHERE id_categoria = '$id_categoria'";
			...
			if($query_categoria){
				 ...
				 echo "<script languaje='JavaScript'>
				      ...
				      alert('LA CATEGORIA QUE INGRESASTE NO EXISTE O ESTA MAL ESCRITO');
				       location.assign('admin_panel.php');
				       </script>";
			}
		}
